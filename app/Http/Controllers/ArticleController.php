...
class ArticleController extends Controller
{
    ...
    public function store(StoreArticleRequest $request)
    {
        ...
        return redirect()->route('article.index')->with("message",$article->title." has been created");
    }
    ...
    public function update(UpdateArticleRequest $request, Article $article)
    {
        ...
        //     return abort(403,"you are not allowed to update this blog");
        // }
        ...
        return redirect()->route('article.index')->with("message",$article->title." has been updated");
    }
